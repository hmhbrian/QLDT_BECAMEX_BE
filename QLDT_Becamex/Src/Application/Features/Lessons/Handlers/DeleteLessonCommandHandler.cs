...
using QLDT_Becamex.Src.Infrastructure.Services; // Dành cho các thao tác LINQ như FirstOrDefaultAsync hoặc SingleOrDefaultAsync
...
namespace QLDT_Becamex.Src.Application.Features.Lessons.Handlers
{
    public class DeleteLessonCommandHandler : IRequestHandler<DeleteLessonCommand>
    {
        ...
        public DeleteLessonCommandHandler(IUnitOfWork unitOfWork, IBaseService baseService, ICloudinaryService cloudinaryService)
        {
