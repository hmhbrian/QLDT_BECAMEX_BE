...
{
    public record CreateCourseStatusCommand(CreateCourseStatusDto Request) : IRequest<Unit>;
    public record DeleteCourseStatusesCommand(List<int> Ids) : IRequest<Unit>;
    public record UpdateCourseStatusCommand(int Id, CreateCourseStatusDto Request) : IRequest<Unit>;
}
