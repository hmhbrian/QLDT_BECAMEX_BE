...
{
    public class GetListQuestionNoAnswerQueryHandler : IRequestHandler<GetListQuestionNoAnswerQuery, PagedResult<QuestionNoAnswerDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetListQuestionNoAnswerQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<PagedResult<QuestionNoAnswerDto>> Handle(GetListQuestionNoAnswerQuery request, CancellationToken cancellationToken)
        {
            ...
            var pageResult = new PagedResult<QuestionNoAnswerDto>(items, pagination);
            return pageResult;
        }
