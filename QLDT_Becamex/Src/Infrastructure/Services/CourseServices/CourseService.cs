...
namespace QLDT_Becamex.Src.Infrastructure.Services.CourseServices
{
    public class CourseService : ICourseService
    {
        ...
        public async Task CalculateAndPersistAsync(string courseId, string userId, CancellationToken ct = default)
        {
            ...
            {
                throw new AppException("Tiến độ khóa học không hợp lệ", 404);
            }
