...
namespace QLDT_Becamex.Src.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateUser([FromBody] UserDtoRq dto)
        {
            ...
            ApiResponse result = await _userService.CreateUserAsync(dto);
        ...
        public async Task<IActionResult> UpdateMyProfile([FromForm] UserUpdateSelfDtoRq rq)
        {
            ...
            ApiResponse result = await _userService.UpdateMyProfileAsync(userId, rq);
        ...
        public async Task<IActionResult> UpdateUserByAdmin(string userId, [FromBody] AdminUpdateUserDtoRq rq)
        {
            ...
            ApiResponse result = await _userService.UpdateUserByAdmin(userId, rq);
        ...
        public async Task<IActionResult> ChangePassword([FromBody] UserChangePasswordRq rq)
        {
            ...
            ApiResponse result = await _userService.ChangePasswordUserAsync(userId, rq);
        ...
        public async Task<IActionResult> ResetPasswordByAdmin(string userId, [FromBody] UserResetPasswordRq rq)
        {
            ...
            ApiResponse result = await _userService.ResetPasswordByAdminAsync(userId, rq);
        ...
        public async Task<IActionResult> SoftDeleteUser(string userId) // Đổi tên phương thức cho rõ ràng hơn
        {
            ...
            ApiResponse result = await _userService.SoftDeleteUserAsync(userId);
